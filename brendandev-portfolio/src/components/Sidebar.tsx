  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-64 bg-gray-900 text-white p-8 flex flex-col justify-between">
      ...
      <div className="flex space-x-4 mt-8 text-xl">
        <a href="https://github.com/your-username" target="_blank" rel="noopener noreferrer">GH</a>
        <a href="https://linkedin.com/in/your-profile" target="_blank" rel="noopener noreferrer">LI</a>
